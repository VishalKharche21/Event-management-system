...
def cstagerent():
    ...
    exitb=Button(f1,text='Exit',width=20,bg='orange',cursor='hand2',command=exit).place(x=280,y=290)
    resetb=Button(f1,text='Reset',width=20,bg='orange',cursor='hand2',command=restb).place(x=430,y=290)
    global p1
    global p2
    global p3
    global p4
    ...
    totalp=Entry(f1,textvariable=text_input,fg='green',font='cambria 10 bold')
    totalp.place(x=430,y=224)
    ms_price=Entry(f1,textvariable=p1)
    ms_price.place(x=235,y=50)
    hs_price=Entry(f1,textvariable=p2)
    hs_price.place(x=235,y=90)
    es_price=Entry(f1,textvariable=p3)
    es_price.place(x=235,y=130)
    bs_price=Entry(f1,textvariable=p4)
    bs_price.place(x=235,y=170)
    ms_entry=Entry(f1,textvariable=d1)
    ms_entry.place(x=450,y=50)
    hs_entry=Entry(f1,textvariable=d2)
    hs_entry.place(x=450,y=90)
    es_entry=Entry(f1,textvariable=d3)
    es_entry.place(x=450,y=130)
    bs_entry=Entry(f1,textvariable=d4)
    bs_entry.place(x=450,y=170)
    stagerent.mainloop()

def restb():
    ms_price.delete(0,END)
    hs_price.delete(0,END)
    es_price.delete(0,END)
    bs_price.delete(0,END)
...
def total_price():
    ...
    t6=eval(d3.get())
    tolll=t5*t6
    text_input.set(tolll)
    tott=tol+toll+tolll
    text_input.set(tott)
    t7=eval(p4.get())
    t8=eval(d4.get())
    tollll=t7*t8
    text_input.set(tollll)

    totalpr=(tol+toll+tolll+tollll)
